# Specification 0024-02: GeoJSON Geometry Transition

## 1. Overview
This specification details the transition from Well-Known Text (WKT) string fields to GeoJSON string fields for representational geometry of field boundaries. This updates PRD 0023 and PRD 0024, eliminating the contradiction.
