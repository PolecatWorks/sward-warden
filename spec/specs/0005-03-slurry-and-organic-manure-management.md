# 0005-04 Slurry and Organic Manure Management Specification

**State**: Open

## Scope
This specification covers the implementation details for Slurry and Organic Manure Management under the Farm Sustainability Standards (FSS) as outlined in PRD 0005.
