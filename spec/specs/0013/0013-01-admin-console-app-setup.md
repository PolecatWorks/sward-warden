...
## 1. Overview
As per PRD 013, the Administration Console must be a separate interface from the main user-facing product. This specification details the setup of a new fe application/container dedicated to administrative and support tasks.
...
- [ ] Ensure local proxy/cors configuration matches the be API.
