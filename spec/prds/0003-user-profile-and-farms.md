...
1. **User Profile Management**
   ...
   - **Profile Content Restrictions**: Do not include navigation links to manage farms on the profile page itself (these are managed in other dedicated app areas). Navigation links to reports are permitted.
