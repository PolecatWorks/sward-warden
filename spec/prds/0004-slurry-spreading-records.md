...
2. **Fertiliser Application Records**
   ...
   - Retain evidence of the right to graze common land or control the agricultural area.

3. **Fertilisation Plan**
   - A written fertilisation plan must be prepared, kept up to date, and made available on the farm by 1 March each year if operating under an approved nitrates derogation, or applying chemical phosphorus fertiliser to grassland, high-phosphorus (P) manures (e.g., pig farmyard manures, poultry litter), or anaerobic digestate.
