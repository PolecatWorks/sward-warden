...
## Overview
This document outlines the strict environmental and reporting standards under the Farm Sustainability Standards (FSS), effective 1 January 2026, replacing previous Cross-Compliance arrangements. Adherence is mandatory to avoid financial penalties ranging from mandatory training to up to a 50% loss of support payments.
...
- **Closed Spreading Periods**:
  - Application of chemical nitrogen or phosphorus fertilisers to grassland is prohibited between 15 September and 31 January.
  - Application to arable land is also prohibited during this time unless there is a demonstrable crop requirement.
- **Urea and Nitrogen Limits**:
