...
Users BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/users    json=${user_data}    expected_status=200
    ...
    # 2. Browse (List) Users
    ${list_response}=    GET    ${BE_BASE_URL}/v0/users    expected_status=200
...
Farms BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/farms    json=${farm_data}    expected_status=200
...
Fields BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/fields    json=${field_data}    expected_status=200
    ...
    ${delete_response}=    DELETE    ${BE_BASE_URL}/v0/fields/${field_id}    expected_status=204
...
Events BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/events    json=${event_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/events    expected_status=200
...
Soil Analyses BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/soil_analyses    json=${soil_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/soil_analyses    expected_status=200
    ...
    ${delete_response}=    DELETE    ${BE_BASE_URL}/v0/soil_analyses/${soil_id}    expected_status=204
...
Fertilisation Plans BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/fertilisation_plans    json=${plan_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/fertilisation_plans    expected_status=200
    ...
    ${delete_response}=    DELETE    ${BE_BASE_URL}/v0/fertilisation_plans/${plan_id}    expected_status=204
...
Farm Records BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/farm_records    json=${record_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/farm_records    expected_status=200
...
Fertiliser Applications BREAD Operations
    ...
    ${event_response}=    POST    ${BE_BASE_URL}/v0/events    json=${event_data}    expected_status=200
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/fertiliser_applications    json=${app_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/fertiliser_applications    expected_status=200
...
Organic Manure Applications BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/organic_manure_applications    json=${app_data}    expected_status=200
    Log    Create Organic Manure Application Response: ${create_response.content}
    ${app_id}=    Convert To String    ${create_response.json()['id']}
    Should Not Be Empty    ${app_id}

    # 2. Browse (List) Organic Manure Applications
    ${list_response}=    GET    ${BE_BASE_URL}/v0/organic_manure_applications    expected_status=200
...
Compliance Breaches BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/compliance-breaches    json=${breach_data}    expected_status=200
    ...
    ${list_response}=    GET    ${BE_BASE_URL}/v0/compliance-breaches    expected_status=200
...
Sward Movements BREAD Operations
    ...
    ${create_response}=    POST    ${BE_BASE_URL}/v0/sward-movements    json=${movement_data}    expected_status=200
...
Admin Endpoints Check
    ...
    # Health
    ${health_response}=    GET    ${BE_BASE_URL}/v0/admin/health    headers=${admin_headers}    expected_status=200
    Log    Admin Health Response: ${health_response.content}
    Should Be Equal As Strings    ${health_response.json()['status']}    ok

    # Farms
    ${farms_response}=    GET    ${BE_BASE_URL}/v0/admin/farms    headers=${admin_headers}    expected_status=200
    Log    Admin Farms Response: ${farms_response.content}
    Should Not Be Empty    ${farms_response.json()}

    # Fields
    ${fields_response}=    GET    ${BE_BASE_URL}/v0/admin/fields    headers=${admin_headers}    expected_status=200
    Log    Admin Fields Response: ${fields_response.content}
    Should Not Be Empty    ${fields_response.json()}

    # Events
    ${events_response}=    GET    ${BE_BASE_URL}/v0/admin/events    headers=${admin_headers}    expected_status=200
    Log    Admin Events Response: ${events_response.content}
    Should Not Be Empty    ${events_response.json()}

    # Audit Logs
    ${logs_response}=    GET    ${BE_BASE_URL}/v0/admin/audit-logs    headers=${admin_headers}    expected_status=200
