...
Field Creation and Deletion Flow
    ...
    New Page    ${EXTERNAL_DNS_URL}/farms/1/fields
    ...
    Click With Options    button:has-text("Add Field")    button=left
    Fill Text    \#newFieldName    E2E Test Field
    Fill Text    \#newFieldArea    15.5
    Click With Options    button:has-text("Save Field")    button=left
    ...
    Click With Options    button[aria-label="Delete E2E Test Field"]    button=left
